...
// as a batch of 1.
type largeLogObjectProcessor struct {
	logger             *zap.Logger
...
func (p *largeLogObjectProcessor) Capabilities() consumer.Capabilities {
	return consumer.Capabilities{MutatesData: true}
}

func (p *largeLogObjectProcessor) Start(_ context.Context, _ component.Host) error {
	return nil
}

func (p *largeLogObjectProcessor) Shutdown(_ context.Context) error {
	return nil
}

func (p *largeLogObjectProcessor) ConsumeLogs(ctx context.Context, ld plog.Logs) error {
...
func (p *largeLogObjectProcessor) estimateLogSize(resource pcommon.Resource, scope pcommon.InstrumentationScope, lr plog.LogRecord) int {
